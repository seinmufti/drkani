...
export function Contact() {
  ...
  return (
    <section id="contact" className="contact section">
      <div className="contact__plants contact__plants--left" aria-hidden="true">
      ...
      <div className="contact__plants contact__plants--right" aria-hidden="true">
        <PlantPot variant="trail" className="contact__pot contact__pot--md" />
      </div>
